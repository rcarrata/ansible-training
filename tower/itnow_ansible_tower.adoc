...
| Identity Manager | https://idm.rober.lab | 18.194.69.201 |
...
* LDAP BIND DN
----
uid=admin,cn=users,cn=compat,dc=rober,dc=lab
----
* LDAP BIND PASSWORD
----
redhat00
...
----
[
 "cn=users,cn=accounts,dc=rober,dc=lab",
 "SCOPE_SUBTREE",
 "(uid=%(user)s)"
]
----
...
----
[
 "cn=groups,cn=accounts,dc=rober,dc=lab",
 "SCOPE_SUBTREE",
...
{
 "is_superuser": [
  "cn=tower.admins,cn=groups,cn=accounts,dc=rober,dc=lab"
 ],
 "is_system_auditor": [
  "cn=tower.auditors,cn=groups,cn=accounts,dc=rober,dc=lab"
 ]
}
----
...
----
{
 ...
 "Operators": {
  "organization": "Default",
  "users": [
   "cn=tower.operators,cn=groups,cn=accounts,dc=rober,dc=lab"
  ],
  "remove": true
 },
 "Linux": {
  "organization": "Default",
  "users": [
   "cn=tower.linux,cn=groups,cn=accounts,dc=rober,dc=lab"
  ],
  "remove": true
 }
}
...
* Access to idM Web ui https://idm.rober.lab/ipa/ui/#/e/user/search (ip address 18.194.69.201, add
* to your local /etc/hosts file "18.194.69.201 idm.rober.lab")
** User: admin
** Password: redhat00
